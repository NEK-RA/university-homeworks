  ...
  while(menuChoice != 0){
    ...
    cout << "1. Найти первый элемент, у которого в троичной записи ровно две двойки" << endl
      ...
      switch(menuChoice){
        ...
        case 1:
          printVectArr(v, "Введенный массив и троичные записи чисел:");
          // Поиск первого эл-та с ровно двумя двойками в троичной записи
          firstTarget = double2in3ss(v);
          if(firstTarget != -1){
        ...
        case 2:
          ...
          if(firstTarget != -1){
            ...
            if(task2num.ok){
              printVectArr(v, "Массив и троичные записи чисел ДО вставки:");
              insertAfter(task2num.num, v, firstTarget);
              printVectArr(v, "Массив и троичные записи чисел ПОСЛЕ вставки:");
            } 
          }else{
        ...
        case 3:
          // Удаление
          printVectArr(v, "Массив и троичные записи чисел ДО удаления элементов:");
          deleteAllTargets(v);
          printVectArr(v, "Массив и троичные записи чисел ПОСЛЕ удаления элементов:");
          break;
...
void printVectArr(VectArr v, string msg){
  cout << msg << endl;
  for(int i = 0; i < v.length; i++){
